...
export default async function handler(req, res) {
  ...
  try {
    ...
    const emailConfig = {
      senderEmail: 'cromero@grove-pt.com',
      senderName: 'Grove Point Labor Reports'
    };
    ...
    for (const restaurant of restaurants) {
      ...
      try {
        ...
        if (header && consolidatedData.length > 0) {
          ...
          restaurantResult.log.push(`✓ Email sent successfully to ${restaurant.datarailsEmail} (${emailResult.messageId})`);
